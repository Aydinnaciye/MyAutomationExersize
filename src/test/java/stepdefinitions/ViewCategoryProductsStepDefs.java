...
public class ViewCategoryProductsStepDefs {
    ...
    ViewCategoryProductsPage viewCategoryPoductsPage=new ViewCategoryProductsPage();
   ...
   // @Given("user clicks category as {string}")
   // public void user_clicks_category_as(String string) {
    ...
    public void user_clicks_on_any_category_under_women_category_on_left_sidebar() {
      //  @Given("user clicks on any sub-category link of category  as {string} on left sidebar")
      //  public void user_clicks_on_any_sub_category_link_of_category_as_on_left_sidebar(String string) {
